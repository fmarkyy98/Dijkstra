...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        btn_search.setOnAction(actionEvent
            ...
            try {
                List<String> dlist = DijkstraAlgorithm.Dijkstra(txt_from.getText(), txt_to.getText());
        ...
        primaryStage.maxWidthProperty().setValue(420);
        primaryStage.maxHeightProperty().setValue(260);
        primaryStage.minWidthProperty().setValue(420);
        primaryStage.minHeightProperty().setValue(260);
